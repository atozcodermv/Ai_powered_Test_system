...
class UserResourceTest {
    ...
    void registerAdmin_successfulRegistration() {
        ...
        when(userService.getUserByEmailid(eq("admin@demo.com"))).thenReturn(null);
    ...
    void registerUser_successfulRegistration() {
        ...
        teacher.setId(10);
        teacher.setRole(UserRole.ROLE_TEACHER.value());
        grade.setTeacher(teacher);

        when(userService.getUserByEmailid(eq("nik@nik.com"))).thenReturn(null);
    ...
    void getStudentsByGrade_successfulFetch() {
        ...
        when(userService.getUsersByRoleAndTeacherAndStatus(UserRole.ROLE_STUDENT.value(), teacher, ActiveStatus.ACTIVE.value())).thenReturn(users);
        when(gradeService.getGradesByTeacherAndStatus(teacher, ActiveStatus.ACTIVE.value())).thenReturn(List.of(grade));
