...
public class ExamResultController {
	...
	@GetMapping("/fetch/performance")
	// Api to fetch student exam performance percentage
	public ResponseEntity<java.util.List<Object[]>> fetchExamPerformanceByStudentId(@RequestParam("studentId") int studentId) {
		return examResultResource.fetchExamPerformanceByStudentId(studentId);
	}
