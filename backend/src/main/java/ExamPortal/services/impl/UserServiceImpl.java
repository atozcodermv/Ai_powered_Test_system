...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<User> getUsersByRoleAndTeacherAndStatus(String role, User teacher, String status) {
		return this.userRepository.findByRoleAndTeacherAndStatus(role, teacher, status);
	}

	@Override
	public List<User> getUsersByRoleAndTeacher(String role, User teacher) {
		return this.userRepository.findByRoleAndTeacher(role, teacher);
	}
